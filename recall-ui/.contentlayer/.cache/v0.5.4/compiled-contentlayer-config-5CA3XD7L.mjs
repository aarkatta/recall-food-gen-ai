...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      title: "Food Alert | Stay Safe",
      author: "Polar Tech",
      headerTitle: "Food Reacall Tracker",
      description: "A food recall tracker to keep you safe",
      language: "en-us",
      theme: "system",
      // system, dark or light
      siteUrl: "https://tailwind-nextjs-starter-blog.vercel.app",
      siteRepo: "https://github.com/timlrx/tailwind-nextjs-starter-blog",
      siteLogo: `${process.env.BASE_PATH || ""}/static/images/ocean.jpeg`,
      locale: "en-US",
...
//# sourceMappingURL=compiled-contentlayer-config-5CA3XD7L.mjs.map
